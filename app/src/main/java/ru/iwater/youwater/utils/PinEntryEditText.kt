...
class PinEntryEditText: AppCompatEditText {
    ...
    private fun init(context: Context, attrs: AttributeSet) {
        ...
        textEmptyPaint?.color = ContextCompat.getColor(context, R.color.blue)
...
//        super.onDraw(canvas);
    ...
    private fun updateColorForLines(next: Boolean) {
        if (isFocused) {
            ...
            mLinesPaint?.color = ContextCompat.getColor(context, android.R.color.darker_gray)
            if (next) {
                mLinesPaint?.color = ContextCompat.getColor(context, R.color.blue)
            }
        } else {
            mLinesPaint?.strokeWidth = mLineStroke
            mLinesPaint?.color = ContextCompat.getColor(context, android.R.color.darker_gray)
